...
$sql = "SELECT NewsID, NewsTitle, NewsDesc FROM news WHERE NewsID = 9";
...
?>
    ...
    <img src="https://geekculture.co/wp-content/uploads/2018/05/deadpool2-review.jpg" alt="" class=" mx-auto d-block ">
