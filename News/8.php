...
$sql = "SELECT NewsID, NewsTitle, NewsDesc FROM news WHERE NewsID = 13";
...
?>
    ...
    <img src="https://www.starwarsnewsnet.com/wp-content/uploads/2018/04/Solo-Star-Wars-Story-Poster-Cropped.jpg" alt="" class=" mx-auto d-block ">
